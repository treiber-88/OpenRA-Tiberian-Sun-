...
notification-chemical-missile-ready = Chemical missile ready.
...
actor-reaper =
    .name = Cyborg Reaper
    .description =
    Elite Nod cyborg armed with quad rocket launchers.
    Heals on Tiberium.
       Strong vs Infantry and Light armor
       Weak vs Vehicles
...
actor-namisl =
    ...
    .chemicalmissilepower-name = Chemical Missile
    .description =
    ...
    at a target location.
    .chemicalmissilepower-description =
    Launches a chemical warhead that spreads
    toxic agents over a wide area.
    Requires a Tiberium Waste Facility to charge.
